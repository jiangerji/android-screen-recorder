...
public class GameLoop extends InvadersScreen implements SimulationListener {
    ...
    Capturing gameScreenCapture;

    public GameLoop(Invaders invaders, Capturing gamescreenCapture) {
        super(invaders);
    ...
    public void draw(float delta) {
        ...
        if (i == 3 || i > 10) {
            ...
            {
                Log.d("aaa", "gameScreenCapture  stop+++++++++++++++++++");
                gameScreenCapture.stopCapturing();
            }
            else if (i == 3)
            {
                Log.d("aaa", "gameScreenCapture  start+++++++++++++++++++");
                gameScreenCapture.startCapturing(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM)
                        + "/inviders.mp4");
            }
            i++;
        }
        ...
        if (gameScreenCapture != null && gameScreenCapture.isStarted())
        {
            ...
            gameScreenCapture.beginCaptureFrame();
            ...
            gameScreenCapture.endCaptureFrame();
        }
    }
